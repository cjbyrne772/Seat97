...
class TixAdapter extends ArrayAdapter<TixData> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView = fasInflater.inflate(R.layout.tix_layout, parent, false);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             //   login1 = new AsyncLogon();
             //   String kbuser = etUser.getText().toString();
             //   String kbpass = etPass.getText().toString();
             //   login1.execute(kbuser, kbpass);
           //fail     Toast.makeText(getActivity(), "Button Clicked", Toast.LENGTH_SHORT).show();
